...
def get_val_info(model, valloader, loss_fn, device, cfg,use_tqdm=False, is_training = False ,print_img = False, weather_class=0 ):
    model.eval()
    total_loss = 0.0
    total_intersect = 0.0
    total_union = 0
    ...
    tinf1 = 0.0
    d=0
    img_save='/home/kaushek/TFGrid/runs/results' ######
    print('running eval...')
