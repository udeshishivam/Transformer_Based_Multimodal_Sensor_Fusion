...
def train(gpuid,
            ...
            sw=1,
            config = '',
            #dataroot='/media/kaushek/e_ssd/Projects/DeepRob/Dataset/NuScenes/',
...
def main():
    ...
    parser.add_argument('--dataroot', default='/home/kaushek/TFGrid/Dataset/', type=str, help='Dataset Path')
    ...
    mp.spawn(train, nprocs=args.gpus, args=(args.split, args.logdir, args.world_size, args.config, args.dataroot) )
    #########################################################################
